...
public class Soulition_programmers_level2_타겟넘버 {
	 ...
	 * 이하인 자연수입니다. 입출력 예 numbers target return [1, 1, 1, 1, 1] 3 5
	 */
	static int ans;
	...
	private static void dfs(int dep, int start, int cal, int[] numbers, int target) {
		...
		dfs(dep + 1, start + 1, cal + numbers[dep], numbers, target);
